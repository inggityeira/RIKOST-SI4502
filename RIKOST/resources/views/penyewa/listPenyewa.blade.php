    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                  ...
                  <div>
                    <form action="{{ route('penyewa.delete', $order->id_penyewa) }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-danger" style="margin-right:70px;" onclick="return confirm('Are you sure to delete penyewa?')">Delete</button>
                    </form>
                </div>

                  <!-- <a href="{{ route('penyewa.delete', $customer->id_penyewa) }}">
