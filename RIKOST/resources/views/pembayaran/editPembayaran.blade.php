          ...
          <div class="col-md-6">
            <form method="POST" action="{{route('update.pembayaran', $list->id_pembayaran)}}">
              ...
              <div class="mb-4">
                ...
                <input type="text" name="termin_pembayaran" id="termin_pembayaran" class="form-control" placeholder="Termin Pembayaran" value="{{$list->termin_pembayaran}}" />
              </div>
              ...
              <div class="mb-4">
                ...
                <input type="text" name="aspek_pembayaran" id="aspek_pembayaran" class="form-control" placeholder="Aspek Pembayaran" value="{{$list->aspek_pembayaran}}" />
              </div>
              ...
              <div class="mb-4">
                ...
                <input type="text" name="status_pembayaran" id="status_pembayaran" class="form-control" placeholder="Status Pembayaran" value="{{$list->status_pembayaran}}" />
              </div>
